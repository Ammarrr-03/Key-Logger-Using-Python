...
# Function to send email alert using Gmail SMTP server
def send_email_alert(suspicious_activity):
    sender = 'ammararsiwala068@gmail.com'  # Replace with your Gmail address
    recipient = 'madman.0333333@gmail.com'  # Replace with the recipient's email
    ...
    try:
        ...
        with smtplib.SMTP('smtp.gmail.com', 587) as server:
            ...
            server.login(sender, 'heiq fmnp zert hear')  # Use your App Password here
...
# Make sure to stop the threads properly when the GUI is closed
def on_closing():
    stop_detection()
    root.destroy()
